...
# Vanessa Ramos
## Portfolio
Contact Info: vgramos@loyola.edu
### About Me
...
#### Grade Calculator
 - This is a grade calculator that tracks assignment names, weight, and points earned. From this it creates a grade for each category and the final grade.
...
![timesheet pic.png](assets/timesheet%20pic.png)
 - [Time Sheet Excel Link](https://studentsloyola-my.sharepoint.com/:x:/g/personal/vgramos_loyola_edu/IQDpmm5hDuR5TrJQDsS5wHFdAViQvS_YLy4duGCYzrrPlJA?e=7Pg6k7&nav=MTVfezZCOUIyRDkxLTM2NjAtNDlDNC1CN0IwLUFEMjdFRjc2N0E5N30)
 - For the time sheet, I wanted a way to keep a log of my work hours, including what position I was in that day. This sheet is mostly based on input, so the only thing I needed to do was create a formula to calculate total bi-weekly time and hours per week. The only struggle was figuring out the day of the week, but instead of just inputting each one, I used a formula so that it pulls it from the input date. With this project, I am able to keep track of the day, time, and duration of each one of my shifts.
